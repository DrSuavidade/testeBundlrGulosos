 ...
 */
export function selectPackageByWeight(totalWeightGrams) {
 ...
 */
export async function calculateShipping(destinationZipRaw, items) {
...
function generateEstimatedQuotes(destZip, originZip, pkg) {
 ...
 */
export async function generateShipmentLabel(input) {
    const pkg = selectPackageByWeight(input.items.reduce((acc, it) => acc + ((it.weightGrams || 250) * it.qty), 0));
