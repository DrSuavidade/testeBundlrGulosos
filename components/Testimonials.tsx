...
export const Testimonials: React.FC = () => {
  ...
  return (
    <section className="relative bg-[#93C5FD] pt-16 md:pt-24 pb-14 md:pb-20 overflow-hidden text-white">
      {/* Top Divider */}
          ...
          {testimonials.map((item, index) => (
            <div
              ...
              className={`absolute inset-0 transition-all duration-700 ease-in-out transform flex flex-col items-center justify-center ${
                index === currentIndex ? 'opacity-100 translate-x-0 scale-100 z-10' : 'opacity-0 translate-x-8 scale-95 pointer-events-none'
              }`}
            >
